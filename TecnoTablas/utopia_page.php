...
<main style="overflow:hidden;padding-top: 8.5%">
	<section id="slide1" class="homeSlide homeSlideTall">
		<div align="left" class="title_underline" style="font-size: 1.5vw;">SOLUCIONES BÁSICAS<br/><b>_</b></div>
...
<td style="width:10%"></td>
			...
			<td style="font-family: nexa; font-size: 1.5vw; padding-left:5%;color:#8E847B;line-height:1.2;;height:33%">
				...
				<li>mobiliario de hogar </li>
				<li>estantería  </li>
				<li>molduras  </li>
				<li>marcos de puertas  </li>
				<li>puertas de armarios  </li>
				<li>revestimiento de paredes  </li>
				</ul>
			</td>
			</tr>
	        </table>
...
<td style="width:10%"></td>
			...
			<td style="font-family: nexa; font-size: 1.5vw; padding-left:5%;color:#8E847B;line-height:1.2;;height:33%">
				<p style="color:black">APLICACIONES</p></br>&nbsp;
				<ul style="columns: 2; -webkit-columns: 2; -moz-columns: 2; padding-left:unset">
				<li>montaje de exposiciones</li>
				<li>separaciones internas</li>
				<li>mamparas</li>
				<li>techos falsos</li>
				</ul>
			</td>
